                ...
                <div class="section-popular-travel row justify-content-center">
                    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="100">
                        <div class="card-travel text-center d-flex flex-column"
                            style="background-image: url('{{ url('frontend/img/popular-1.jpg') }}')">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="250">
                        <div class="card-travel text-center d-flex flex-column"
                            style="background-image: url('{{ url('frontend/img/popular-2.jpg') }}')">
                            <div class="travel-country">INDONESIA</div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="400">
                        <div class="card-travel text-center d-flex flex-column"
                            style="background-image: url('{{ url('frontend/img/popular-3.jpg') }}')">
                            <div class="travel-country">INDONESIA</div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="550">
                        <div class="card-travel text-center d-flex flex-column"
                            style="background-image: url('{{ url('frontend/img/popular-4.jpg') }}')">
                            <div class="travel-country">EROPA</div>
